...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	lightingShader.initialize("../Shaders/lightColorShader.vs", "../Shaders/lightColorShader.fs");
	lampShader.initialize("../Shaders/lampShader.vs", "../Shaders/lampShader.fs");

	VertexColor vertex[24] = {
		// Face front
		{ glm::vec3(1, 1, 1), glm::vec3(1.0, 0.0, 0.0) },
	    { glm::vec3(-1, 1,1), glm::vec3(0.0, 1.0, 0.0) },
	    { glm::vec3(-1, -1, 1), glm::vec3(0.0, 0.0, 1.0) },
	    { glm::vec3(1, -1, 1), glm::vec3(1.0, 1.0, 0.0) },
		// Face right
		{ glm::vec3(1, 1, -1), glm::vec3(0.0, 0.0, 1.0) },
		{ glm::vec3(1, 1, 1), glm::vec3(1.0, 0.0, 1.0) },
		{ glm::vec3(1, -1, 1), glm::vec3(0.0, 1.0, 0.0) },
		...
		// Face down
		{ glm::vec3(1, -1, 1), glm::vec3(1.0, 0.0, 1.0) },
		{ glm::vec3(-1, -1, 1), glm::vec3(1.0, 1.0, 1.0) },
		{ glm::vec3(-1, -1, -1), glm::vec3(0.0, 1.0, 1.0) },
		{ glm::vec3(1, -1, -1), glm::vec3(1.0, 1.0, 0.0) } 
	};
