...
in vec3 our_normal;
in vec2 our_uv;
in float visibility; //Agregar la visibilidad
...
uniform vec3 fogColor; //Agregar variable para cambiar color
...
void main()
{
    ...
    color = mix(vec4(fogColor, 1.0), color, visibility);//Agregar para la mezcla de los colores 
}
