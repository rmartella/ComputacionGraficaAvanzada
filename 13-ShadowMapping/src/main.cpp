...
Shader shaderViewDepth; // Primera fase de renderizado.
//Shader para dibujar el buffer de profundidad en pantalla.
Shader shaderDepth; 
...
void applicationLoop() {
	...
	while (psi) {
		...
		// Solo para debug, visualizar el render anterior.
		/*glViewport(0, 0, screenWidth, screenHeight);
		glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
...
void prepareDepthScene(){  // Si se agregan otros objetos en la escena se debe settear el shader de profundidad.
