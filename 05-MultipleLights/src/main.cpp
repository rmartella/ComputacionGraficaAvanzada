...
void applicationLoop() {
	...
	while (psi) {
		...
		for (int i = 0; i < lamp1Position.size(); i++){
			...
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(i) + "].light.ambient", glm::value_ptr(glm::vec3(0.5, 0.16, 0.01)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(i) + "].light.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.2)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(i) + "].light.specular", glm::value_ptr(glm::vec3(0.1, 0.58, 0.3)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(i) + "].position", glm::value_ptr(lampPosition));
			shaderMulLighting.setFloat("pointLights[" + std::to_string(i) + "].constant", 1.0);
			shaderMulLighting.setFloat("pointLights[" + std::to_string(i) + "].linear", 0.09);
			shaderMulLighting.setFloat("pointLights[" + std::to_string(i) + "].quadratic", 0.01);
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(i) + "].light.ambient", glm::value_ptr(glm::vec3(0.5, 0.16, 0.01)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(i) + "].light.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.02)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(i) + "].light.specular", glm::value_ptr(glm::vec3(0.6, 0.58, 0.03)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(i) + "].position", glm::value_ptr(lampPosition));
			shaderTerrain.setFloat("pointLights[" + std::to_string(i) + "].constant", 1.0);
			shaderTerrain.setFloat("pointLights[" + std::to_string(i) + "].linear", 0.009);
			shaderTerrain.setFloat("pointLights[" + std::to_string(i) + "].quadratic", 0.002);
		}

		for (int i = 0; i < lamp2Position.size(); i++)
		{
			glm::mat4 matrixAdjustPosition = glm::mat4(1.0);
			matrixAdjustPosition = glm::translate(matrixAdjustPosition, lamp2Position[i]);									 //Traslación.
			matrixAdjustPosition = glm::rotate(matrixAdjustPosition, glm::radians(lamp2Orientation[i]), glm::vec3(0, 1, 0)); //Rotación.
			matrixAdjustPosition = glm::scale(matrixAdjustPosition, glm::vec3(1.0, 1.0, 1.0));								 //Escalado.
			matrixAdjustPosition = glm::translate(matrixAdjustPosition, glm::vec3(1.132	, 5.147, 0));					 //Traslación de luz a la posicion de la lampara
			...
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(i + lamp1Position.size()) + "].light.specular", glm::value_ptr(glm::vec3(0.6,0.58,0.03)));
			...
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(i + lamp1Position.size()) + "].light.specular", glm::value_ptr(glm::vec3(0.6,0.58,0.03)));
